...
export function ContactSection() {
  ...
  return (
    <section className="relative w-full font-sans bg-gray-50/30 min-h-screen py-24 px-6 md:px-12 flex items-center justify-center">
      <div className="w-full max-w-6xl mx-auto relative z-10 mt-10 md:mt-16">
        <motion.div
          initial={{ opacity: 0, y: 40 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, ease: "easeOut" }}
          className="rounded-[2.5rem] border border-black/5 bg-white p-8 md:p-16 shadow-2xl hover:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.15)] transition-shadow duration-500 relative overflow-hidden grid grid-cols-1 lg:grid-cols-5 gap-16 lg:gap-24 items-start"
        >
          {/* Left: Contact Details */}
          <div className="col-span-1 lg:col-span-2 flex flex-col gap-10 z-10 w-full">
            <div className="flex flex-col gap-4">
              <div className="rounded-full bg-black/5 border border-black/10 backdrop-blur-md px-4 py-1.5 shadow-sm inline-flex w-fit">
                <span className="text-xs md:text-sm font-semibold text-black/80 uppercase tracking-widest">
                  Contact Us
                </span>
              </div>
              <h1 className="text-5xl md:text-6xl font-extrabold text-black tracking-tight leading-[1.1]">
                Let&apos;s talk.
              </h1>
          ...
          {/* Right: Form */}
          <div className="col-span-1 lg:col-span-3 w-full z-10 flex flex-col justify-center h-full">
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <Input
                    ...
                    required
                    className="border-black/15 focus:border-black rounded-xl h-12 text-base font-medium placeholder:text-black/30 bg-transparent"
                  />
                </div>
